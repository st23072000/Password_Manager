...
const Navbar = () => {
    return (
        ...
        <nav className='bg-slate-800 text-white' >
            ...
            <svg class="w-6 h-6 text-green-300 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
